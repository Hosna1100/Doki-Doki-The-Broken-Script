...
define audio.virtualreality = "<loop 0>mod_assets/virtualreality.ogg"
...
image bg e_bedroom = "mod_assets/bg/bedroom-e.png"
image bg deleted_scenes = "mod_assets/bg/deletedscenes.png"
image bg hidden_room = "mod_assets/bg/hiddenroom.png"
image bg club_day2:
    choice:
        "bg club_day"
    choice:
...
image mysteriousfigure myfi = im.Composite((960, 960), (0, 0), "mod_assets/3.png", (0, 0), "mod_assets/b1.png")
image newchr neter = im.Composite((960, 960), (0, 0), "mod_assets/1l.png", (0, 0), "mod_assets/1r.png", (0, 0), "mod_assets/e.png")
image natsuri 7a = im.Composite((960, 960), (0, 0), "mod_assets/4a.png", (0, 0), "mod_assets/aa.png")
image natsuri 7j = im.Composite((960, 960), (0, 0), "mod_assets/4a.png", (0, 0), "mod_assets/aj.png")
image natsuri 7d = im.Composite((960, 960), (0, 0), "mod_assets/4a.png", (0, 0), "mod_assets/bd.png")
image natsuri 8a = im.Composite((960, 960), (0, 0), "mod_assets/4b.png", (0, 0), "mod_assets/aa.png")
image natsuri 8j = im.Composite((960, 960), (0, 0), "mod_assets/4b.png", (0, 0), "mod_assets/aj.png")
image natsuri 8d = im.Composite((960, 960), (0, 0), "mod_assets/4b.png", (0, 0), "mod_assets/bd.png")
image satsuki 9c = im.Composite((960, 960), (0, 0), "mod_assets/l2.png", (0, 0), "mod_assets/r2.png", (0, 0), "mod_assets/nc.png")
image satsuki 9d = im.Composite((960, 960), (0, 0), "mod_assets/l2.png", (0, 0), "mod_assets/r2.png", (0, 0), "mod_assets/nd.png")
image glitch 1 = im.Composite((960, 960), (0, 0), "mod_assets/justglitch.png")


define narrator = Character(ctc="ctc", ctc_position="fixed")
define mc = DynamicCharacter('player', what_prefix='"', what_suffix='"', ctc="ctc", ctc_position="fixed")
define s = DynamicCharacter('s_name', image='sayori', what_prefix='"', what_suffix='"', ctc="ctc", ctc_position="fixed")
define c = DynamicCharacter('c_name', image='newchr', what_prefix='"', what_suffix='"', ctc="ctc", ctc_position="fixed")
define m = DynamicCharacter('m_name', image='monika', what_prefix='"', what_suffix='"', ctc="ctc", ctc_position="fixed")
define n = DynamicCharacter('n_name', image='natsuki', what_prefix='"', what_suffix='"', ctc="ctc", ctc_position="fixed")
define y = DynamicCharacter('y_name', image='yuri', what_prefix='"', what_suffix='"', ctc="ctc", ctc_position="fixed")
define mf = DynamicCharacter('mf_name', image='mysteriousfigure', what_prefix='"', what_suffix='"', ctc="ctc", ctc_position="fixed")
define ns = DynamicCharacter('ns_name', image='natsuri', what_prefix='"', what_suffix='"', ctc="ctc", ctc_position="fixed")
define ss = DynamicCharacter('ss_name', image='satsuki', what_prefix='"', what_suffix='"', ctc="ctc", ctc_position="fixed")
define gl = DynamicCharacter('gl_name', image='glitch', what_prefix='"', what_suffix='"', ctc="ctc", ctc_position="fixed")
...
default y_name = "Yuri"
default c_name = "NewChr"
default mf_name = "MysterFigure"
default ns_name = "Natsuri"
default ss_name = "Satsuki"
default gl_name = "Glitch"
